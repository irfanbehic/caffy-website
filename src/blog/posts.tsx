...
const CONTENT: Record<LocaleCode, Localized[]> = {
  en: [
    { title: "How long does caffeine stay in your body?",
      ...
      body: [
        ...
        { t: "ul", items: [
          "**Pregnancy and oral contraceptives** slow it down. In late pregnancy the half-life can reach 15 hours.",
    ...
    { title: "What time should you stop drinking coffee for better sleep?",
      ...
      body: [
        ...
        { t: "callout", s: "Caffy calculates a personal **safe cutoff time** from your bedtime and metabolism, then warns you before an afternoon drink eats into tonight's sleep." },
      ] },
    { title: "How much caffeine is in coffee, tea, espresso and energy drinks?",
      ...
      body: [
        ...
        { t: "ul", items: [
          ...
          "**Espresso (1 shot):** ~63–80 mg, the strongest per ounce",
    ...
    { title: "Safe daily caffeine limits: how much is too much?",
      ...
      body: [
        ...
        { t: "p", s: "ACOG, EFSA and the NHS all recommend **no more than 200 mg per day** in pregnancy. Caffeine is cleared much more slowly then, and its half-life can rise to **~15 hours** in the third trimester, so it accumulates." },
        { t: "ul", items: [
          "Jitteriness, a racing heart, or anxiety",
          "Trouble falling or staying asleep",
          "Headaches, or an afternoon crash you “need” more caffeine to fix" ] },
        { t: "callout", s: "Caffy sets a personal daily limit and shows a live gauge, so you can see when you're approaching 400 mg, before it happens rather than after." },
      ] },
    { title: "How to cut back on caffeine without the headaches",
      ...
      body: [
        ...
        { t: "p", s: "Cut caffeine abruptly and the symptoms (**headache, fatigue, irritability**) typically begin **12–24 hours** later and can last **2–9 days**. It's a real rebound, not weakness." },
        { t: "art", kind: "leaf", caption: "Ease off gently, and your body barely notices." },
  ...
  tr: [
    { title: "Kafein vücudunda ne kadar kalır?",
      ...
      body: [
        { t: "p", s: "Öğleden sonra 2'deki kahve akşam yemeğinde bitmiş olmaz. Kafein vücuttan **yarı ömrünün** belirlediği öngörülebilir bir programla atılır ve bu, günlük alışkanlığın hakkında bilebileceğin en yararlı bilgidir." },
        ...
        { t: "p", s: "Sabah 9'da **200 mg** (büyük bir kahve) içersen, öğleden sonra hâlâ yaklaşık **100 mg** dolaşımda olur. Kafeinin etkisiz hâle gelmesi için kabaca **5–6 yarı ömür, yani neredeyse tam bir gün** gerekir." },
    ...
    { title: "Kahve, çay, espresso ve enerji içeceğinde ne kadar kafein var?",
      ...
      body: [
        { t: "p", s: "“Bir kahve” 60 mg da olabilir, 300 mg da. İşte Mayo Clinic ve CSPI verilerine göre tipik miktarlar. Günlük limitinin altında kalmak için işine yarar." },
        ...
        { t: "p", s: "Birincisi **boyut**: 470 ml'lik bir zincir kahvesi 2–3 “fincan” kafein taşıyabilir. İkincisi, **espresso daha güçlü hissettirir** ama tek shot çoğu zaman bir fincan filtreden daha az toplam kafein içerir; sadece daha yoğundur." },
        { t: "callout", s: "Caffy'de bu içecekler ve yüzlercesi hazır tanımlı gelir. Kaydetmek tek dokunuş ve her biri canlı kafein seviyene eklenir." },
      ] },
    { title: "Güvenli günlük kafein limiti: ne kadarı fazla?",
      excerpt: "FDA ve EFSA çoğu yetişkin için günde 400 mg'da hemfikir, hamilelikte ise 200 mg. İşte bu rakamların fincan cinsinden karşılığı.",
      ...
      body: [
        ...
        { t: "p", s: "Hem **FDA** hem **Avrupa Gıda Güvenliği Otoritesi (EFSA)**, çoğu sağlıklı ve hamile olmayan yetişkin için günde **400 mg'a kadar kafeini** güvenli sayıyor. Bu kabaca **dört fincan kahve** demek." },
  ...
  de: [
    { title: "Wie lange bleibt Koffein im Körper?",
      ...
      body: [
        ...
        { t: "p", s: "Trinkst du um 9 Uhr **200 mg** (ein großer Kaffee), zirkulieren am Nachmittag noch etwa **100 mg**. Bis Koffein praktisch weg ist, dauert es rund **5–6 Halbwertszeiten, also fast einen ganzen Tag**." },
        { t: "h2", s: "Warum dein Wert individuell ist" },
        { t: "ul", items: [
          "**Schwangerschaft und Antibabypille** verlangsamen ihn. Spät in der Schwangerschaft bis zu 15 Stunden.",
    ...
    { title: "Wie viel Koffein steckt in Kaffee, Tee, Espresso und Energydrinks?",
      ...
      body: [
        ...
        { t: "callout", s: "Caffy hat diese Getränke und Hunderte mehr integriert. Das Erfassen ist ein Tipp, und jedes fließt in deinen Live-Koffeinwert." },
      ] },
    { title: "Sichere Koffein-Tagesmenge: wie viel ist zu viel?",
      ...
      body: [
        ...
        { t: "p", s: "ACOG, EFSA und der NHS empfehlen in der Schwangerschaft **höchstens 200 mg pro Tag**. Koffein wird dann viel langsamer abgebaut, und die Halbwertszeit kann im dritten Trimester auf **~15 Stunden** steigen." },
        { t: "ul", items: [
        ...
        { t: "callout", s: "Caffy setzt ein persönliches Tageslimit und zeigt eine Live-Anzeige, damit du siehst, wann du dich 400 mg näherst, vorher statt danach." },
      ] },
    { title: "Koffein reduzieren, ohne Kopfschmerzen",
      ...
      body: [
        ...
        { t: "p", s: "Setzt du Koffein abrupt ab, beginnen die Symptome (**Kopfschmerz, Müdigkeit, Reizbarkeit**) meist **12–24 Stunden** später und halten **2–9 Tage** an. Das ist ein echter Rückschlag, keine Schwäche." },
        { t: "art", kind: "leaf", caption: "Sanft reduzieren, und dein Körper merkt es kaum." },
  ...
  es: [
    ...
    { title: "¿Cuánta cafeína hay en café, té, espresso y bebidas energéticas?",
      ...
      body: [
        ...
        { t: "callout", s: "Caffy incluye estas bebidas y cientos más, así que registrar es un toque y cada una suma a tu nivel de cafeína en vivo." },
      ] },
    { title: "Límite diario seguro de cafeína: ¿cuánto es demasiado?",
      ...
      body: [
        ...
        { t: "p", s: "ACOG, EFSA y el NHS recomiendan **no más de 200 mg al día** en el embarazo. La cafeína se elimina mucho más lento entonces, y su vida media puede subir a **~15 horas** en el tercer trimestre." },
        { t: "ul", items: [
          "Nerviosismo, taquicardia o ansiedad",
          "Dificultad para conciliar o mantener el sueño",
          "Dolores de cabeza o un bajón de tarde que “necesitas” arreglar con más cafeína" ] },
        { t: "callout", s: "Caffy fija un límite diario personal y muestra un indicador en vivo, para que veas cuándo te acercas a 400 mg, antes y no después." },
      ] },
    { title: "Cómo reducir la cafeína sin dolores de cabeza",
      ...
      body: [
        ...
        { t: "art", kind: "leaf", caption: "Baja poco a poco, y tu cuerpo apenas lo nota." },
  ...
  ja: [
    { title: "カフェインはどれくらい体内に残る？",
      ...
      body: [
        { t: "p", s: "午後2時のコーヒーは夕食時にはまだ残っています。カフェインは**半減期**が決める予測可能なスケジュールで抜けていきます。これは毎日の習慣について知るべき最も役立つ知識です。" },
        { t: "h2", s: "「半減期」とは" },
        ...
        { t: "ul", items: [
          "**妊娠・経口避妊薬**は代謝を遅くします。妊娠後期には半減期が15時間になることもあります。",
          "**喫煙**は速くし、半減期をおよそ半分に。",
    ...
    { title: "コーヒー・お茶・エスプレッソ・エナジードリンクのカフェイン量は？",
      excerpt: "エスプレッソ、ドリップ、コールドブリュー、緑茶、レッドブル。実際に何を飲んでいるか分かる、出典付きの比較です。",
      sourceLabels: ["Mayo Clinic — 飲料のカフェイン量", "CSPI — カフェイン一覧"],
      body: [
        { t: "p", s: "「コーヒー1杯」は60mgのことも300mgのこともあります。Mayo ClinicとCSPIのデータによる目安です。1日の上限内に収めるのに便利です。" },
        ...
        { t: "ul", items: [
          ...
          "**コーラ（355ml）:** 約35〜40mg" ] },
        { t: "h2", s: "つまずきやすい2点" },
        { t: "p", s: "第一に**サイズ**：470mlのカフェのコーヒーは2〜3「杯」分のカフェインを含みます。第二に、**エスプレッソは強く感じます**が、1ショットの総カフェインはドリップ1杯より少ないことが多いのです。ただ濃いだけです。" },
        { t: "callout", s: "Caffyにはこれらの飲み物や数百種が内蔵され、記録はワンタップで、それぞれがリアルタイムのカフェイン量に加算されます。" },
      ] },
    { title: "安全な1日のカフェイン量：どこからが多すぎ？",
      ...
      body: [
        ...
        { t: "h2", s: "妊娠中は別" },
        { t: "p", s: "ACOG、EFSA、NHSはいずれも妊娠中は**1日200mgまで**を推奨します。この時期はカフェインの代謝がずっと遅くなり、妊娠後期には半減期が**約15時間**まで延び、蓄積します。" },
        { t: "ul", items: [
          "手の震え、動悸、不安",
          "寝つき・寝つづきの悪さ",
          "頭痛や、さらにカフェインで「直したくなる」午後の失速" ] },
        { t: "callout", s: "Caffyは個人向けの1日の上限を設定し、ライブのゲージを表示します。400mgに近づいていることを、後ではなく事前に確認できます。" },
      ] },
    { title: "頭痛なしでカフェインを減らす方法",
      ...
      body: [
        ...
        { t: "ul", items: [
          ...
          "水分を取り、数日は低調でも大丈夫。やがて過ぎ去ります。" ] },
        { t: "callout", s: "Caffyのデトックスプランはこの減量を自動で組み（5〜14日）、毎日を記録します。減らすことが戦いではなく前進に感じられます。" },
      ] },
